...
func (x *GreetingRequest) GetLanguage() string {
	if x != nil {
		return x.Language
	}
	return ""
...
var file_greeter_proto_rawDesc = []byte{
	...
	0x41, 0x0a, 0x0f, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
...
var file_greeter_proto_depIdxs = []int32{
	0, // 0: Greeter.SayHello:input_type -> GreetingRequest
	1, // 1: Greeter.SayHello:output_type -> GreetingResponse
...
func (c *greeterClient) SayHello(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingResponse, error) {
...
func (*UnimplementedGreeterServer) SayHello(context.Context, *GreetingRequest) (*GreetingResponse, error) {
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayHello(ctx, req.(*GreetingRequest))
	}
